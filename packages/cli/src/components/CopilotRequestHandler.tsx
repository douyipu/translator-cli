...
import type { CopilotRequest, CopilotResponse } from "@douyipu/translator-cli-core";
...
const getContextualDisplay = (
    ...
    let isCoherent = beforeSrc.endsWith(currentTranslationSrc);
    let displayBefore = "";
    let hasGap = false;
    let gapText = "";
    ...
    if (isCoherent) {
        ...
        hasGap = true;
        // throw new Error(
        //   JSON.stringify({ beforeSrc, currentTranslationSrc, srcString })
        // );
...
// (This function is partially visible but the core logic is clear)
    ...
    return (
        <Box flexDirection="column">
            <Box borderStyle="single" width="50%" flexDirection="column">
                ...
                {contextDisplay.hasGap && <Text color="red">{contextDisplay.gapText}</Text>}
